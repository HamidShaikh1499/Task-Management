...
export default function MainLayout({ children }) {
    ...
    return (
        <div className="h-screen w-screen flex flex-row">
            <div className="w-72 relative shadow h-screen flex flex-col bg-gray-700">
                <div className="flex flex-row space-x-4 px-2 py-4 items-center">
                    ...
                    <p className="text-2xl leading-6 text-white">Task Management</p>
                </div>

                <div className="flex flex-col w-full space-y-4 mt-6 px-2">
                    <button onClick={() => navigate('/')} className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">
                        ...
                        <p className="text-base leading-4 ">Task</p>
                    </button>
                    <button onClick={() => navigate('/profile')} className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-indigo-400   rounded ">
                        <svg className="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="px-2 py-4 absolute bottom-0">
                    <button onClick={() => dispatch(logout())} className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">
